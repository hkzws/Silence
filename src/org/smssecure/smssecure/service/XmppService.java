      ...
      new AsyncTask<XmppService, Void, Void>() {
        ...
        protected Void doInBackground(XmppService... params) {
          ...
          try {
            ...
            ReconnectionManager reconnectionManager = ReconnectionManager.getInstanceFor(instance.connection);
            reconnectionManager.enableAutomaticReconnection();
            reconnectionManager.setEnabledPerDefault(true);
            reconnectionManager.setDefaultFixedDelay(RECONNECTION_DELAY);
